...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .story-section{
                width:100%;
                height:28.125rem;
                background: url('../img/media/ipad4.jpg') no-repeat center;
            ...
            .book-food{
                width:100%;
                background:url('../img/media/ipad5.jpg') no-repeat center;
                background-size: cover;
    ...
    <body>
        ...
        <main id="hero" class="d-flex align-items-center">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 d-flex flex-column justify-content-center order-3  order-3 order-lg-1 pt-lg-0 " data-aos="fade-up" data-aos-delay="200">
                        <h1>iPad Pro</h1>
                    ...
                    <div class="col-lg-6 order-1 order-lg-2 hero-img mb-5" data-aos="zoom-in" data-aos-delay="200">
                        <img src="../img/media/hero_ipad.png" class="img-fluid animated" alt="">
                    </div>
                </div>
            </div>
        </main>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-7 col-md-12 mb-lg-0 mb-5">
                            <div class="card border-0">
                                <img decoding="async" src="../img/media/ipad2.jpg" class="img-fluid">
                            </div>
                        </div>
                ...
                <div class="container food-type">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-7 col-md-12">
                            <div class="card border-0">
                                <img decoding="async" src="../img/media/ipad1.webp" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
