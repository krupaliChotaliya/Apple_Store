    ...
    <head>
        ...
        <style>
            ...
            .story-section{
                width:100%;
                height:28.125rem;
                background: url('../img/media/airpods5.jpg') no-repeat center;
            ...
            .book-food{
                width:100%;
                background:url('../img/media/airpods2.jpg') no-repeat center;
                background-size: cover;
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 order-1 order-lg-2 hero-img mb-5" data-aos="zoom-in" data-aos-delay="200">
                        <img src="../img/media/airpods_hero.png" class="img-fluid animated" alt="">
                    </div>
                </div>
            </div>
        </main>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-7 col-md-12 mb-lg-0 mb-5">
                            <div class="card border-0">
                                <img decoding="async" src="../img/media/airpods3.jpg" class="img-fluid">
                            </div>
                        </div>
                ...
                <div class="container food-type">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-7 col-md-12">
                            <div class="card border-0">
                                <img decoding="async" src="../img/media/airpods4.webp" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
